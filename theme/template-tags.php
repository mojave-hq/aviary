...
if ( ! function_exists( 'aviary_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function aviary_posted_on() {
...
if ( ! function_exists( 'aviary_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function aviary_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'aviary_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function aviary_entry_footer() {
...
if ( ! function_exists( 'aviary_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function aviary_post_thumbnail() {
